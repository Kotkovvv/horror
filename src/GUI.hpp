...
GUI_touch1 ex(&exi, 100, 100, 50, 0.05, 0.05, -0.05, -0.05);///<объект кнопки выхода в меню
GUI_touch1 con(&cont, 100, 100, 50, 0.05, 0.05, -0.05, -0.05);///<объект кнопки продолжения игры
GUI_touch1 les(&lesss, 100, 100, 50, 0.05, 0.05, -0.05, -0.05);///<объект кнопки
GUI_touch1 mor(&more, 100, 100, 50, 0.05, 0.05, -0.05, -0.05);///<объект кнопки
